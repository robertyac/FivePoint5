                    ...
                    <div class="card-body mx-auto">
                        <div class="tabcontent " id="settings">
                            ...
                            <div class="container profilePicContainer">
                                <div class="row">
                                    <div class="col-md-6"><img src="img/defaultProfilePic.png" alt="Profile Picture" style="max-width:300px;"></div>
                            ...
                            <div class="container">
                                ...
                                <form class="d-flex align-items-center w-50" role="form">
                                    Username:
                                    <input class="form-control me-2 ml-3" id="username" type="text" placeholder="Connor" aria-label="Text">
                                </form>
                                Age: &nbsp;&nbsp;&nbsp; 23 <br>
