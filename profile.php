                    ...
                    <div class="card-body mx-auto">
                        <div class="tabcontent " id="settings">
                            ...
                            <div class="container profilePicContainer m-4">
                                <div id="divImageClick" class="row border border-2 border-dark rounded me-4" style="min-height: 20em; max-width: 20em">
                                    <form action="/FivePoint5/commands/changeProfilePic.php" accept="image/*" method="post" id="profileForm" enctype="multipart/form-data" novalidate>
                                        <?php
                            ...
                            <div class="container">
                                <form action="/FivePoint5/commands/changeUsername.php" method="post" class="d-flex align-items-center w-50 m-4" role="form" style="min-width: 300px">
                                    Username:
                                    <input class="form-control ms-3" id="newUsername" type="text" value="<?php echo $_SESSION['user']; ?>" aria-label="Text" name="newUsername" required>
                                </form>
                                <form action="/FivePoint5/commands/changeEmail.php" method="post" class="d-flex align-items-center w-50 m-4" role="form" style="min-width: 300px">
                                    Email:
                                    <input class="form-control ms-3" id="newEmail" type="email" value="<?php echo getEmail($_SESSION['user']) ?>" aria-label="Text" name="newEmail">
                                </form>
                                <section id="favTags">
